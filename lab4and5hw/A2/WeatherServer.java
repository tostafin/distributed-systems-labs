...
public class WeatherServer {
    ...
    private static class WeatherService extends WeatherSubscriptionGrpc.WeatherSubscriptionImplBase {
        ...
        WeatherService(Collection<SubscriptionResponse> subscriptionResponses) {
            ...
            SubscriptionResponse weatherInPoland = SubscriptionResponse.newBuilder().setCountry("Poland").setTemperature(20).setHumidity(60).build();
            SubscriptionResponse weatherInGermany = SubscriptionResponse.newBuilder().setCountry("Germany").setTemperature(10).setHumidity(90).build();
            SubscriptionResponse weatherInSpain = SubscriptionResponse.newBuilder().setCountry("Spain").setTemperature(35).setHumidity(20).build();
