...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default double avg(double[] numbers)
    {
        return avg(numbers, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double avg(double[] numbers, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(numbers, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(double[] numbers)
    {
        return _iceI_avgAsync(numbers, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> avgAsync(double[] numbers, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_avgAsync(double[] iceP_numbers, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "avg", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeDoubleSeq(iceP_numbers);
                 }, istr -> {
                     double ret;
                     ret = istr.readDouble();
                     return ret;
