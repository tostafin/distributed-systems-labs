...
public class IceClient 
{
	public static void main(String[] args) {
		...
		try {
			...
			ObjectPrx base4 = communicator.stringToProxy("calc/calc44:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); //opcja -z włącza możliwość kompresji wiadomości

			// 3. Rzutowanie, zawężanie (do typu Calc)
			CalcPrx obj1 = CalcPrx.checkedCast(base1);
			CalcPrx obj3 = CalcPrx.checkedCast(base3);
			CalcPrx obj4 = CalcPrx.checkedCast(base4);
			if (obj1 == null || obj3 == null || obj4 == null) throw new Error("Invalid proxy");
			...
			do {
				try {
					...
					if (line == null) {
						...
						double r = obj4.avg(new double[]{2.5, 3.5});
						System.out.println("RESULT = " + r);
